...
| Directory                        | Purpose                                                                         |
| -------------------------------- | ------------------------------------------------------------------------------- |
| [architecture/](./architecture/) | Config guide, library policy, Mirror Room 공개 배포·SFU·무대/다자/오디오 로드맵 |
...
- [**Mirror Room — 무대/관객 UI · 다자 · DJ 오디오 로드맵**](./architecture/mirror-room-stage-multiparticipant-audio-plan.md) — Phase 1~3, 시그널/SFU, 오디오 믹스 수용 기준.
